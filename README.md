...
- **Animation**: `g_timeout_add(50-100ms)` drives `GtkImage` with scaled `GdkPixbuf` (16-48px bilinear). Delay is CPU-proportional: `CPU<20→100ms` (10 FPS), `20-40→90ms`, `40-60→80ms`, `60-80→70ms`, `80-90→60ms`, `>=90→50ms` (20 FPS).
